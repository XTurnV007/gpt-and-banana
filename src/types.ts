...
export type BuiltInApiProvider = 'openai' | 'fal' | 'nano-banana'
...
export interface TaskParams {
  ...
  banana_image_size: '2K'
  banana_aspect_ratio: '1:1' | '4:3' | '3:4' | '16:9' | '9:16' | '2:3' | '3:2'
  banana_quality: 'standard' | 'high'
}
