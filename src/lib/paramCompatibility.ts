...
export function normalizeParamsForSettings(
  ...
  const nextParams: TaskParams = {
    ...
    banana_image_size: params.banana_image_size || DEFAULT_PARAMS.banana_image_size,
    banana_aspect_ratio: params.banana_aspect_ratio || DEFAULT_PARAMS.banana_aspect_ratio,
    banana_quality: params.banana_quality || DEFAULT_PARAMS.banana_quality,
  }
